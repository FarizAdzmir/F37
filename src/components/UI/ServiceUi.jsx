...
export default function ServiceUi({ title, description, items }) {
  ...
  return (
    <div ref={serviceUi} className=" mt-10 grid grid-cols-1 gap-5 md:grid-cols-2 md:gap-24">
      ...
      <div ref={services}  className=" select-none leading-[2.3rem] bg-gradient-to-r from-red-500 to-purple-500 text-transparent bg-clip-text md:leading-[2.5rem] lg:leading-[3.4rem]  translate-y-10 opacity-0">
